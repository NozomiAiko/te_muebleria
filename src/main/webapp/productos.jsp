...
<head>
    ...
    <meta name="keywords" content="muebles,productos, best sellers, cocina, dormitorio, baño, madera, diseños, hogar, armarios, roperos, estante, mueble de baño">
</head>
    ...
    <main>
            ...
            <div class="productos2">
                ...
                <div class="productostargetas text-center img-fluid" style="width: 18rem;">
                    ...
                    <div class="card-productos">
                        <h5 class="card-title">Mueble de baño</h5>
        ...
        <div class="containerproductos2">
            <a name="bano" id="bano" title="">
                <h4 data-aos="fade-right" class="textoproductos">Baño</h4>
            </a>
            <div class="productos2">
                <div class="productostargetas text-center img-fluid" style="width: 18rem;">
